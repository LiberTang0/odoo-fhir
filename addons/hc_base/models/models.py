...
class HumanName(models.Model):
    ...
    mother_maiden_family_name_id = fields.Many2one(comodel_name="hc.human.name.term", string="Mother Maiden Family Name", help="Mother's original family name.")
    birth_family_name_id = fields.Many2one(comodel_name="hc.human.name.term", string="Birth Family Name", help="Person's family name at birth.")

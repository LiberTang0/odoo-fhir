...
class CountryRegion(models.Model):  
    ...
    type_id = fields.Many2one(comodel_name="hc.vs.country.division.type", string="Division Type", help="Type of grouping of divisions (e.g. Region in the US).")
...
class HumanNameGiven(models.Model): 
    ...
    name_type = fields.Selection(string="Type", selection=[("first", "First"), ("middle", "Middle"), ("initial", "Initial"), ("nickname", "Nickname")], help="Type of given name.")
